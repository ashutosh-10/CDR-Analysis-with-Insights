...
def create_app_ui():
    ...
    html.Marquee('CDR Analysis with Insights', id='Main_title', style={'textAlign': 'center','color': '#FFFFFF',
            'font-family': 'Malgun Gothic', 'fontSize':'50px'}),
    ...
    ,style={'background-image':'url("/assets/download.jpg")','background-repeat': 'no-repeat','background-size': '100% 100%'})
...
html.Video(controls = True,
            id = 'movie_player',
            src = "/assets/My Videoo.mp4",
            height = "200",
            autoPlay=1, style = {'min-width': '30%',
  'min-height': '30%'}),

  html.Audio(  id = 'ad',controls = True,  src = "/assets/ad.mp3",autoPlay= True),
'''
